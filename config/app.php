...
//		Opcodes\LogViewer\Level::class,
    ...
    */
    ...
    'serversImagePath' => env('APP_URL') .  env('SERVERS_DIR_URL'),
    'appsImagePath' => env('APP_URL') .  env('APPS_DIR_URL'),
    'sponsoradsImagePath' => env('APP_URL') .  env('SPONSOR_ADS_DIR_URL'),
    'admobadsImagePath' => env('APP_URL') .  env('ADMOB_ADS_DIR_URL'),

    'proxy_api_url' => env('PROXY_CHECK_API_URL'),
    'proxy_api_response_type' => env('PROXY_CHECK_API_RESPONSE_TYPE'),
    'proxy_api_key' => env('PROXY_CHECK_API_KEY'),
    'proxy_api_fields' => env('PROXY_CHECK_API_REQ_FIELDS'),
