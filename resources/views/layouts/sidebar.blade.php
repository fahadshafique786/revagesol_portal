  ...
  <aside class="main-sidebar sidebar-dark-info elevation-4 custom-siderbar-dark">
	...
	<a class="brand-link p-2 custom custom-nav-background" href="{{ route('dashboard') }}">
...
<!--           style="opacity: .8">-->
        <h4 class="mb-0 text-center text-white "> {{ config('app.name', 'Revage Solution') }} </h4>

	</a>

    <!-- Sidebar -->
    <div class="sidebar custom-nav-background">
...
{{--        @endif--}}
            ...
            <li class="nav-header text-white py-3">ACCOUNTS MANAGEMENT </li>
                @if(auth()->user()->can('view-accounts')  || auth()->user()->hasRole('super-admin'))
                    <li class="nav-item">
                        <a href="{{ url('admin/accounts') }}" class="nav-link {{ (Request::segment(2) == 'accounts') ? 'active' : '' }}">
							...
							<img src="{{ asset('dist/img/sidebar-icons/sports.png') }}" class=" "/>
                            <p>Accounts</p>
                        </a>
                    </li>
                @endif
            ...
            <li class="nav-header text-white py-3"> APP CONFIGURATION </li>
            @endif
        ...
        @if((auth()->user()->can('view-app_settings') && auth()->user()->can('view-accounts')  && auth()->user()->can('manage-accounts')  )   || auth()->user()->hasRole('super-admin'))
                    ...
                    <li class="nav-item">
                        <a href="{{ url('admin/app_settings') }}" class="nav-link {{ (Request::segment(2) == 'app_settings') ? 'active' : '' }}">
							<img src="{{ asset('dist/img/sidebar-icons/settings.png') }}" class=" "/>
                            <p>App Setting</p>
                        </a>
                    </li>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/app') }}" class="nav-link {{ (Request::segment(2) == 'app') ? 'active' : '' }}">
                        <img src="{{ asset('dist/img/sidebar-icons/application.png') }}" class=" "/>
                        <p>Applications</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/admob_ads') }}" class="nav-link {{ (Request::segment(2) == 'admob_ads') ? 'active' : '' }}">
                        <img src="{{ asset('dist/img/sidebar-icons/amobs.png') }}" class=" "/>
                        <p>Admob Ads</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/sponsors') }}" class="nav-link {{ (Request::segment(2) == 'sponsors') ? 'active' : '' }}">
                        <img src="{{ asset('dist/img/sidebar-icons/sponsor.png') }}" class=" "/>
                        <p>Sponsor Ads</p>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a href="{{ url('admin/credentials') }}" class="nav-link {{ (Request::segment(2) == 'credentials') ? 'active' : '' }}">
							<img src="{{ asset('dist/img/sidebar-icons/app_credential.png') }}" class=" "/>
                        <p>App Credentials</p>
                    </a>
                </li>
            ...
            @endif
                ...
                <li class="nav-header text-white py-3">FIREBASE CONFIGURATION </li>
                ...
                <li class="nav-item ">
                    <a href="{{ url('admin/firebase-credentials') }}" class="nav-link {{ (Request::segment(2) == 'firebase-credentials') ? 'active' : '' }}">
							<img src="{{ asset('dist/img/sidebar-icons/credentials.png') }}" class=" "/>
                ...
                <li class="nav-item ">
                    <a href="{{ url('admin/sync-data') }}" class="nav-link {{ (Request::segment(2) == 'sync-data') ? 'active' : '' }}">
                        <img src="{{ asset('dist/img/sidebar-icons/sync.png') }}" class=" "/>
                        <p> Sync Data</p>
                    </a>
                </li>
                @endif
