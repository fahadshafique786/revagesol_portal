        ...
        <div class="col-xl-3 col-md-3" id="application{{$obj->id}}">
            <div class="card custom text-center">
                <label class="form-label text-left" for="allappscheckbox-{{$obj->id}}">
                    <input value="{{$obj->id}}" type="checkbox" data-id="{{$obj->id}}" class="sub_chk" id="allappscheckbox-{{$obj->id}}" name="removeAllAppsCheckbox" />
                </label>
                <a class="ik ik-settings f-18 text-dark" href="{{url('/admin/app/'.$obj->id)}}">
                    ...
                    <div class="row">
                        <div class="col-6">
                            @if(auth()->user()->hasRole('super-admin') || auth()->user()->can('manage-applications'))
                                <a class="ik d-block ik-settings f-18 text-green" href="{{url('/admin/app/'.$obj->id)}}">
                                    <i class="fa fa-cog"></i>
                                </a>
                            @endif
                        </div>
